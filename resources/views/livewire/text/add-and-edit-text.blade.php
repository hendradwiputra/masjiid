<x-layouts.content>
    ...
    <div class="flex items-center">
        ...
        <h1 class="text-xl font-semibold text-gray-800 mb-6 mt-6">Pengaturan Teks</h1>
    </div>

    <form wire:submit="updatePraytime">
        <div class="space-y-6">
                ...
                <div class="border-t border-gray-200 p-5">
                    <div class="grid grid-cols-1 lg:grid-cols-3">
                        <label for="adzan_label" class="block text-base font-semibold mb-2">
                            Layar adzan
                            <p class="text-sm text-gray-700 font-light">Ini akan ditampilkan di layar adzan.</p>
                        </label>
                ...
                <div class="border-t border-gray-200 p-5">
                    <div class="grid grid-cols-1 lg:grid-cols-3">
                        <label for="iqomah_label" class="block text-base font-semibold mb-2">
                            Layar iqomah
                            <p class="text-sm text-gray-700 font-light">Ini akan ditampilkan di layar iqomah.</p>
                        </label>
    ...
    <div class="flex items-center mt-5">
        <img src="{{ 'storage/images/icon/point.png' }}" alt="logo" class="h-5">
        <h1 class="text-xl font-semibold text-gray-800 mb-6 mt-6">Running Text</h1>
    </div>
</x-layouts.content>