<div class="bg-gray-50 font-mavenpro">
    <div class="flex h-screen overflow-hidden">
        ...
        <div class="flex-1 overflow-auto">
            <!-- Mobile header -->
            <div class="h-16 flex sticky top-0 items-center justify-between px-4 border-b border-gray-200 bg-white lg:hidden">
            ...
            <div id="mobileHeader" class="lg:hidden hidden bg-white border-b border-gray-200 px-4 py-3">
                <div class="flex items-center justify-end space-x-4">            
                    <div class="flex items-center space-x-3">
                        ...
                        <div class="relative">
                            <button id="mobileProfileButton" class="flex items-center text-sm font-medium rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-100">
                                ...
                                <svg class="ml-1 h-4 w-4 text-gray-500" fill="currentColor" viewBox="0 0 20 20" stroke="#374151" stroke-width="1">
                                    <path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"></path>
                                </svg>
                            </button>
                            
                            <div id="mobileProfileDropdown" class="hidden origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-gray-100 ring-opacity-5 focus:outline-none z-50">
            ...
            <!-- Desktop header -->
            <div class="hidden lg:flex sticky top-0 items-center justify-end h-16 px-6 border-b border-gray-200 bg-white">                                
                <div class="flex items-center space-x-4">                                        
                    <!-- User profile dropdown -->
                    <div class="relative ml-3">
                        <button id="profileButton" class="flex items-center max-w-xs text-sm font-medium rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-100">
                            <img class="h-8 w-8 rounded-full" src="{{ 'storage/images/icon/user-circle.png'}}" alt="user">
                            <span class="ml-2 hidden md:inline">{{ Auth::user()->name }}</span>
                            <svg class="ml-1 h-4 w-4 text-gray-500" fill="currentColor" viewBox="0 0 20 20" stroke="#374151" stroke-width="1.25">
                                <path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"></path>
                            </svg>
                        </button>
                        
                        <div id="profileDropdown" class="hidden origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-gray-100 ring-opacity-5 focus:outline-none z-50">
            ...
            <!-- Content area -->
            <div class="p-6 pt-6">
                <h1 class="text-xl font-semibold text-gray-800 mb-6">{{ $pageTitle }}</h1>
