    ...
    <div class="flex-1 overflow-y-auto">
        <nav class="px-2 py-4">
            <div class="space-y-1.5">
                <!-- Dashboard -->
                <a href="/dashboard"
                    class="flex items-center px-2 py-3 text-sm font-medium rounded-md group hover:bg-blue-100
                ...
                <div class="group space-y-1.5">
                    <button 
                        id="projectsMenu" 
                        class="flex items-center justify-between w-full px-2 py-3 text-sm font-medium rounded-md hover:bg-blue-100
