<div class="flex flex-col lg:flex-row min-h-screen">
    <!-- Left Section -->
    <div class="w-full lg:w-1/2 bg-gradient-to-l from-gray-800 to-gray-600">
        <!-- Profile -->
        <div class="w-full p-5 transition-all duration-700 ease-in-out">
        ...
        <!-- Current Date -->
        <div class="p-2 mb-5 text-right border-t-2 border-gray-600">
            <div class="flex flex-col">
                <div class="font-semibold text-stone-200 text-md lg:text-xl text-shadow-lg mr-1">
        ...
        <div class="mx-4">
            <div class="font-nunito text-white">
                <div class="grid grid-cols-1 gap-2 md:gap-4">
                    @for ($i=1; $i<=6; $i++) <div
                        class="prayer-card bg-gradient-to-r from-blue-500 to-blue-400 rounded-full px-5 p-1 lg:p-3 flex items-center justify-between shadow-md hover:shadow-lg transition-all duration-300"
                        id="{{ $i }}">
...
<!-- Right Section -->
<div class="w-full lg:w-1/2 relative min-h-[500px] lg:min-h-screen hidden lg:block">
    <!-- Next Prayer -->
    <div class="z-50 fixed right-1 pt-2">
    ...
    <!-- Clock -->
    <div class="fixed bottom-20 right-4 lg:right-1 z-10">
        <div class="flex flex-row bg-gradient-to-r from-stone-400 to-stone-200 rounded-sm shadow-lg p-2">
            <x-partials.clock />
        </div>
    </div>
</div>
