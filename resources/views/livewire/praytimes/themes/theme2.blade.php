<div class="h-screen bg-gradient-to-r from-gray-900 to-gray-400 text-white overflow-hidden flex flex-col">
    ...
    <div class="flex-1 flex overflow-hidden">
        ...
        <div class="w-full lg:w-1/2 flex flex-col relative">
            ...
            <!-- Praytimes Section -->
            <div class="relative flex-1 flex items-center justify-center px-8 py-2 pb-22">
                ...
                <!-- Next Prayer Section -->
                <div id="nextprayer-section" class="flex justify-center items-center">
    ...
    <div class="hidden lg:block w-1/2 relative overflow-hidden">
        ...
        <div id="profile-section" class="flex justify-end items-center absolute top-0 right-0 p-2 bg-gradient-to-r from-black/70 via-transparent to-black/70
            ...
            {{-- Profile --}}
            <div class="flex w2/3 items-center justify-end gap-4">
        ...
        <!-- Clock -->
        <div id="clock-section" class="fixed bottom-23 right-4 lg:right-1 px-1 z-10 hidden lg:block">
            <x-partials.clock-1 />
        </div>
    </div>
</div>
