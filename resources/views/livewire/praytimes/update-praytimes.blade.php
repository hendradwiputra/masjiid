...
<form wire:submit="update">
    <div class="flex items-center">
        ...
        <h1 class="text-base lg:text-xl font-semibold text-gray-800 mb-6 mt-6">Konfigurasi Waktu Sholat
        </h1>
    </div>
    ...
    <div class="flex items-center">
        <img src="{{ 'storage/images/icon/point.png' }}" class="h-5" alt="logo">
        <h1 class="text-base lg:text-xl font-semibold text-gray-800 mb-6 mt-6">Notifikasi</h1>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div class="border border-gray-200 rounded-2xl">
            ...
            <div class="border-t border-gray-200 p-5 space-y-6">
                <div>
                    <label for="sunrise_caption" class="block text-base font-medium mb-2">
                        Ketika matahari terbit</label>
                    <textarea wire:model="sunrise_caption"
                        class="text-base lg:text-base mt-1 px-2 py-3 block w-full rounded-md border border-gray-300 shadow-sm focus:border-sky-500 focus:outline-none"
                        rows="3"></textarea>
                    @error('sunrise_caption') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                </div>
                <div>
                    <label for="adhan_caption" class="block text-base font-medium mb-2">
                        Ketika adzan</label>
                    <textarea wire:model="adhan_caption"
                        class="text-base lg:text-base mt-1 px-2 py-3 block w-full rounded-md border border-gray-300 shadow-sm focus:border-sky-500 focus:outline-none"
                        rows="3"></textarea>
                    @error('adhan_caption') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                </div>
                <div>
                    <label for="iqomah_caption" class="block text-base font-medium mb-2">
                        Ketika iqomah</label>
                    <textarea wire:model="iqomah_caption"
                        class="text-base lg:text-base mt-1 px-2 py-3 block w-full rounded-md border border-gray-300 shadow-sm focus:border-sky-500 focus:outline-none"
                        rows="3"></textarea>
    ...
    <div class="flex items-center">
        <img src="{{ 'storage/images/icon/point.png' }}" class="h-5" alt="logo">
        <h1 class="text-base lg:text-xl font-semibold text-gray-800 mb-6 mt-6">Hitung Mundur</h1>
    </div>
        ...
        <div class="border-t border-gray-200 p-5">
            <div class="grid grid-cols-2 gap-x-2 sm:grid-cols-6 space-y-6">
                <div>
                    ...
                    @error('prayer1_iqomah_duration') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                </div>
                <div>
                    ...
                    @error('prayer3_iqomah_duration') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                </div>
                <div>
                    ...
                    @error('prayer4_iqomah_duration') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                </div>
                <div>
                    ...
                    @error('prayer5_iqomah_duration') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                </div>
                <div>
                    ...
                    @error('prayer6_iqomah_duration') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="border border-gray-200 rounded-t-2xl">
        <div class="px-4 py-5 bg-gray-100 rounded-t-2xl">
            ...
            <p class="text-base font-medium text-gray-600 italic">Kunci layar di waktu sholat berikut</p>
        </div>
        <div class="border-t border-gray-200 p-5">
            <div class="grid grid-cols-1 gap-x-2 sm:grid-cols-3 space-y-6">
                <div>
                    <label for="sunrise_lock_duration" class="block text-base font-medium mb-2">Ketika matahari
                        terbit</label>
                    ...
                    @error('sunrise_lock_duration') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                </div>
                <div>
                    <label for="prayer_lock_duration" class="block text-base font-medium mb-2">Ketika sholat
                        berjamaah</label>
                    ...
                    @error('prayer_lock_duration') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                </div>
                <div>
                    <label for="jumuah_lock_duration" class="block text-base font-medium mb-2">Ketika Sholat
                        Jumat</label>
                    ...
                    @error('jumuah_lock_duration') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                </div>
            </div>
        </div>
    </div>
