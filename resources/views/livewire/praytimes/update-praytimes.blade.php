    ...
    <form wire:submit="update">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div class="border border-gray-200 rounded-2xl shadow-2xl">
                ...
                <div class="border-t border-gray-200 p-5 space-y-6">
                    <div>
                        <label for="latitude" class="block text-base font-semibold mb-2">Garis lintang</label>
                    ...
                    <div>
                        <label for="longitude" class="block text-base font-semibold mb-2">Garis bujur</label>
            ...
            <div class="border border-gray-200 rounded-2xl shadow-2xl">
                ...
                <div class="border-t border-gray-200 p-5 space-y-6">
                    <div>
                        <label for="timezone" class="block text-base font-semibold mb-2">Time zone</label>
                    ...
                    <div>
                        <label for="dst" class="block text-base font-semibold mb-2">Daylight Saving Time</label>
                        <input wire:model="dst" type="text"
                            class="text-base  mt-1 px-2 py-3 block w-full rounded-md border border-gray-300 shadow-sm focus:border-sky-500 focus:outline-none focus:ring-sky-500">
                        @error('dst') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div class="border border-gray-200 rounded-2xl shadow-2xl">
                ...
                <div class="border-t border-gray-200 p-5 space-y-6">
                    <div>
                        <label for="time_format" class="block text-base font-semibold mb-2">Tampilkan dalam
                            format</label>
            ...
            <div class="border border-gray-200 rounded-2xl shadow-2xl">
                ...
                <div class="border-t border-gray-200 p-5 space-y-6">
                    <div>
                        <label for="hijri_correction" class="block text-base font-semibold mb-2">Koreksi tanggal</label>
                        ...
                        @error('hijri_correction') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="grid grid-cols-2 gap-x-2 sm:grid-cols-6 space-y-6">
                    <div>
                        ...
                        <input wire:model="prayer1_alias" type="text"
                            class="text-base mt-1 px-2 py-3 block w-full rounded-md border border-gray-300 shadow-sm focus:border-sky-500 focus:outline-none focus:ring-sky-500">
                        @error('prayer1_alias') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>
                    <div>
                        <label for="prayer2" class="block text-base font-semibold mb-2">{{ Str::Title($prayer2_alias)
                            }}</label>
                    ...
                    <div>
                        <label for="prayer3" class="block text-base font-semibold mb-2">{{ Str::Title($prayer3_alias)
                            }}</label>
                    ...
                    <div>
                        <label for="prayer4" class="block text-base font-semibold mb-2">{{ Str::Title($prayer4_alias)
                            }}</label>
                    ...
                    <div>
                        <label for="prayer5" class="block text-base font-semibold mb-2">{{ Str::Title($prayer5_alias)
                            }}</label>
                    ...
                    <div>
                        <label for="prayer6" class="block text-base font-semibold mb-2">{{ Str::Title($prayer6_alias)
                            }}</label>
        ...
        <div class="border border-gray-200 rounded-2xl shadow-2xl mt-6">
            ...
            <div class="border-t border-gray-200 p-5">
                <div class="grid grid-cols-2 gap-x-2 sm:grid-cols-6 space-y-6">
                    <div>
                        <label for="prayer1_correction" class="block text-base font-semibold mb-2">{{
                            Str::Title($prayer1_alias) }}</label>
                        ...
                        @error('prayer1_correction') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>
                    <div>
                        <label for="prayer2_correction" class="block text-base font-semibold mb-2">{{
                        ...
                        @error('prayer2_correction') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>
                    <div>
                        <label for="prayer3_correction" class="block text-base font-semibold mb-2">{{
                        ...
                        @error('prayer3_correction') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>
                    <div>
                        <label for="prayer4_correction" class="block text-base font-semibold mb-2">{{
                        ...
                        @error('prayer4_correction') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>
                    <div>
                        <label for="prayer5_correction" class="block text-base font-semibold mb-2">{{
                        ...
                        @error('prayer5_correction') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>
                    <div>
                        <label for="prayer6_correction" class="block text-base font-semibold mb-2">{{
                        ...
                        @error('prayer6_correction') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div class="border border-gray-200 rounded-2xl shadow-2xl">
                ...
                <div class="border-t border-gray-200 p-5 space-y-6">
                    <div>
                        <label for="adhan_duration" class="block text-base font-semibold mb-2">Jarak antara adzan ke
                            iqomah</label>
                        ...
                        @error('adhan_duration') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="border border-gray-200 rounded-2xl shadow-2xl mt-6">
            ...
            <div class="border-t border-gray-200 p-5">
                <div class="grid grid-cols-2 gap-x-2 sm:grid-cols-6 space-y-6">
                    <div>
                        <label for="prayer1_iqomah_duration" class="block text-base font-semibold mb-2">{{
                            Str::Title($prayer1_alias) }}</label>
                        ...
                        @error('prayer1_iqomah_duration') <span class="text-red-500 text-sm">{{ $message }}</span>
                        @enderror
                    </div>
                    <div>
                        <label for="prayer3_iqomah_duration" class="block text-base font-semibold mb-2">{{
                            Str::Title($prayer3_alias) }}</label>
                        ...
                        @error('prayer3_iqomah_duration') <span class="text-red-500 text-sm">{{ $message }}</span>
                        @enderror
                    </div>
                    <div>
                        <label for="prayer4_iqomah_duration" class="block text-base font-semibold mb-2">{{
                            Str::Title($prayer4_alias) }}</label>
                        ...
                        @error('prayer4_iqomah_duration') <span class="text-red-500 text-sm">{{ $message }}</span>
                        @enderror
                    </div>
                    <div>
                        <label for="prayer5_iqomah_duration" class="block text-base font-semibold mb-2">{{
                            Str::Title($prayer5_alias) }}</label>
                        ...
                        @error('prayer5_iqomah_duration') <span class="text-red-500 text-sm">{{ $message }}</span>
                        @enderror
                    </div>
                    <div>
                        <label for="prayer6_iqomah_duration" class="block text-base font-semibold mb-2">{{
                            Str::Title($prayer6_alias) }}</label>
                        ...
                        @error('prayer6_iqomah_duration') <span class="text-red-500 text-sm">{{ $message }}</span>
                        @enderror
                    </div>
                </div>
            </div>
        ...
        <div class="border border-gray-200 rounded-2xl shadow-2xl">
            ...
            <div class="border-t border-gray-200 p-5">
                <div class="grid grid-cols-1 gap-x-2 sm:grid-cols-3 space-y-6">
                    <div>
                        <label for="sunrise_lock_duration" class="block text-base font-semibold mb-2">{{
                            Str::Title($prayer2_alias) }}</label>
                        ...
                        @error('sunrise_lock_duration') <span class="text-red-500 text-sm">{{ $message }}</span>
                        @enderror
                    </div>
                    <div>
                        <label for="prayer_lock_duration" class="block text-base font-semibold mb-2">Sholat
                            berjamaah</label>
                        ...
                        @error('prayer_lock_duration') <span class="text-red-500 text-sm">{{ $message }}</span>
                        @enderror
                    </div>
                    <div>
                        <label for="jumuah_lock_duration" class="block text-base font-semibold mb-2">Khutbah
                            Jumat</label>
                        ...
                        @error('jumuah_lock_duration') <span class="text-red-500 text-sm">{{ $message }}</span>
                        @enderror
                    </div>
                </div>
            </div>
