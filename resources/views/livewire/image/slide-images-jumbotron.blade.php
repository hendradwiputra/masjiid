<x-layouts.content>
    ...
    <div class="flex items-center">
        ...
        <h1 class="text-xl font-semibold text-gray-800 mb-6 mt-6">Slide Jumbotron</h1>
    </div>
                ...
                <table class="w-full table-auto">
                    <thead class="text-sm text-gray-700">
                        <tr class="bg-gray-100 border-t border-gray-200">
                            ...
                            <th class="px-4 py-2 text-left">Berakhir</th>
                            <th class="px-4 py-2 text-left"></th>
                        </tr>
                    </thead>
                    <tbody class="text-sm">
                        @foreach ($slide_jumbotron as $slide)
                        <tr class="border-t border-gray-200">
                            ...
                            <td class="px-4 py-2">
                                {{ Str::limit($slide->content, 50) ?? '-' }}
                            </td>
                            <td class="px-4 py-2">
                                {{ $slide->start_date->format('d M Y') }}
                            </td>
                            <td class="px-4 py-2">
                                {{ $slide->end_date->format('d M Y') }}
                            </td>
                            <td class="px-4 py-2">
    ...
    <div x-data="{ showDeleteModal: @entangle('showDeleteModal') }" x-show="showDeleteModal" x-cloak
        ...
        <div class="bg-white rounded-lg p-6 w-full max-w-md">
            ...
            <p class="mb-4">Apakah Anda yakin ingin menghapus slide ini?</p>
