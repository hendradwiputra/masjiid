        ...
        <div class="font-mavenpro bg-white shadow-md rounded-xl px-6 py-8">
            ...
            <form class="space-y-4" wire:submit="login">
                ...
                <div>
                    ...
                    <div class="mt-1">
                        <input name="name" type="name"
                            class="@error('name') is-invalid @enderror px-2 py-3 mt-1 block w-full rounded-md border border-gray-300 shadow-sm focus:border-sky-500 focus:outline-none focus:ring-sky-500 sm:text-sm"
                ...
                <div>
                    ...
                    <div class="mt-1">
                        <input name="password" type="password"
                            class="@error('password') is-invalid @enderror px-2 py-3 mt-1 block w-full rounded-md border border-gray-300 shadow-sm focus:border-sky-500 focus:outline-none focus:ring-sky-500 sm:text-sm"
                ...
                <p class="text-center text-sm text-gray-900">
                    Tidak punya akun? Buat akun baru <a href="{{ route('register') }}"
                        class="text-blue-500 hover:underline font-semibold">di sini</a>
                </p>
            </form>
        </div>
    </div>
