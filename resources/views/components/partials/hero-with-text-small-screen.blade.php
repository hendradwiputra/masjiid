<div class="relative w-full h-full min-h-screen overflow-hidden">
    ...
    <div class="absolute inset-0 flex items-center justify-center z-40 pointer-events-none">
        <div class="text-center p-2 sm:p-4 bg-opacity-70 max-w-7xl">
            <h2 id="slide-title"
                class="font-bold text-amber-300 text-xl md:text-4xl leading-tight text-shadow-sm text-shadow-gray-900 mb-2">
                {{ $randomImages[0]['title'] ?? '' }}
            </h2>
            <p id="slide-content"
                class="font-semibold text-stone-50 text-sm md:text-3xl text-shadow-sm text-shadow-gray-900 leading-none mb-1 mx-auto">
                {{ $randomImages[0]['content'] ?? '' }}
            </p>
            <p id="slide-author"
                class="font-semibold text-stone-50 text-base md:text-xl italic text-shadow-sm text-shadow-gray-900 mb-1 mx-auto">
