...
'ghost-secondary' => 'text-slate-600 hover:bg-slate-50',
...
$baseClass = "inline-flex items-center justify-center gap-2 font-medium rounded-lg w-full transition-all duration-200
