...
<div x-data="{ mobileSidebarOpen: false }">
    ...
    <div x-ref="sidebar" x-show="$store.sidebar.isOpen || window.innerWidth >= 1024" :class="{
        ...
        class="inset-y-0 left-0 z-30 w-64 bg-white border-r border-gray-200 flex flex-col h-screen transform transition-transform duration-200 ease-in-out"
        style="will-change: transform;">

        <!-- Sidebar logo -->
        <header class="h-16 px-4 flex items-center justify-between">
            <a href="/" class="flex items-center text-rose-600">
